...
import models.video_models.lstm as lstm_models
if opt.model_dir != '':
...
if opt.model == 'dcgan':
    if opt.image_width == 64:
        import models.video_models.dcgan_64 as model 
    elif opt.image_width == 128:
        import models.video_models.dcgan_128 as model  
elif opt.model == 'vgg':
    if opt.image_width == 64:
        import models.video_models.vgg_64 as model
    elif opt.image_width == 128:
        import models.video_models.vgg_128 as model
else:
